...
Another way to import an Excel spreadsheet is via code:

```{r}
library(readxl)
For205Tutorial <- read_excel("~/Documents/Data Analysis/For205Tutorial.xlsx", 
    sheet = "Group 1")
View(For205Tutorial)
```

When you need to import more than one sheet from Excel, you can use the above code, copying it exactly and changing the sheet title (instead of Group 1, it might be Group 2).
