...
We have a nice looking graph, so let's add the regression line with "geom_smooth(method=lm, se = FALSE). This will allow a linear trendline.
...
So we want a trendline equation
